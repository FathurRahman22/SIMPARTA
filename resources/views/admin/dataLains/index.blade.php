                ...
                <tbody>
                    @foreach($dataLains as $key => $dataLain)
                        <tr data-entry-id="{{ $dataLain->id }}">
                            ...
                            <td>
                                @can('data_lain_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.data-lains.show', $dataLain->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('data_lain_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.data-lains.edit', $dataLain->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('data_lain_delete')
                                    <form action="{{ route('admin.data-lains.destroy', $dataLain->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@endcan
  ...
  let table = $('.datatable-DataLain:not(.ajaxTable)').DataTable({ buttons: dtButtons })
