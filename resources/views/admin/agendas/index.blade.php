...
@section('content')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/agenda/agenda_index.css') }}">
    @can('agenda_create')
    ...
    <div class="card">
        ...
        {{ trans('global.list') }} {{ trans('cruds.agenda.title_singular') }}
        </div>
                                ...
                                <td>
                                    @can('agenda_show')
                                        <a class="btn btn-xs btn-primary"
                                            href="{{ route('admin.agendas.show', $agenda->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Agenda:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
