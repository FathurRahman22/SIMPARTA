        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.agendas.update', [$agenda->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nama_agenda') ? 'is-invalid' : '' }}" type="text"
                        name="nama_agenda" id="nama_agenda" value="{{ old('nama_agenda', $agenda->nama_agenda) }}"
                        required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('deskripsi_agenda') ? 'is-invalid' : '' }}"
                        name="deskripsi_agenda" id="deskripsi_agenda">{!! old('deskripsi_agenda', $agenda->deskripsi_agenda) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="needsclick dropzone {{ $errors->has('gambar_agenda') ? 'is-invalid' : '' }}"
                        id="gambar_agenda-dropzone">
                    </div>
