...
<script>
    ...
    var regionTotals = [{{ $dataKunjungan->asean }}, {{ $dataKunjungan->asia }},{{ $dataKunjungan->timur_tengah }},{{ $dataKunjungan->eropa }},{{ $dataKunjungan->amerika }},{{ $dataKunjungan->oseania }},{{ $dataKunjungan->afrika }},];
...
<script>
    ...
    var region2Totals = [{{ $dataKunjungan->jawa }}, {{ $dataKunjungan->kalimantan }},{{ $dataKunjungan->sumatera }},{{ $dataKunjungan->sulawesi }},{{ $dataKunjungan->bali_nustra }},{{ $dataKunjungan->papuaa }}];
...
<script>
    ...
    var regions = ['Aceh', 'Sumatera Utara', 'Riau', 'Kepulauan Riau', 'Jambi', 'Sumatera Barat', 'Sumatera Selatan', 'Kepulauan Bangka Belitung', 'Bengkulu', 'Lampung'];
    var populations = [
        {{ $dataKunjungan->aceh }},
        {{ $dataKunjungan->sumut }},
        {{ $dataKunjungan->riau }},
...
<script>
    ...
    var regions = ['Sulawesi Utara', 'Sulawesi Barat', 'Sulawesi Tengah', 'Sulawesi Selatan', 'Sulawesi Tenggara', 'Gorontalo'];
    var populations = [
        {{ $dataKunjungan->sulut }},
...
<script>
    ...
    var regions = ['Maluku', 'Maluku Utara', 'Papua', 'Papua Barat', 'Papua Barat Daya', 'Papua Selatan', 'Papua Tengah', 'Papua Pegunungan'];
    var populations = [
