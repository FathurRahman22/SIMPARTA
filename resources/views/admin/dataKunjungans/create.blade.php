...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.dataKunjungan.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.data-kunjungans.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="dataprofil_id">{{ trans('cruds.dataKunjungan.fields.dataprofil') }}</label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.dataKunjungan.fields.sumsel_helper') }}</span>
                        </div>
                        <div class="col-md-6">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.dataKunjungan.fields.bangka_helper') }}</span><br>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.dataKunjungan.fields.maluku_helper') }}</span>
                        </div>
                        <div class="col-md-4">
