                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('asean') ? 'is-invalid' : '' }}" type="number"
                                    name="asean" id="asean" value="{{ old('asean', '') }}" step="1">
                                @if ($errors->has('asean'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('asean') }}
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('malaysia') ? 'is-invalid' : '' }}"
                                        type="number" name="malaysia" id="malaysia" value="{{ old('malaysia', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('filipina') ? 'is-invalid' : '' }}"
                                        type="number" name="filipina" id="filipina" value="{{ old('filipina', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('singapura') ? 'is-invalid' : '' }}"
                                        type="number" name="singapura" id="singapura" value="{{ old('singapura', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('thailand') ? 'is-invalid' : '' }}"
                                        type="number" name="thailand" id="thailand" value="{{ old('thailand', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('vietnam') ? 'is-invalid' : '' }}"
                                        type="number" name="vietnam" id="vietnam" value="{{ old('vietnam', '') }}"
                                        step="1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('asia') ? 'is-invalid' : '' }}" type="number"
                                    name="asia" id="asia" value="{{ old('asia', '') }}" step="1">
                                @if ($errors->has('asia'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('asia') }}
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control {{ $errors->has('hongkong') ? 'is-invalid' : '' }}"
                                        type="number" name="hongkong" id="hongkong" value="{{ old('hongkong', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control {{ $errors->has('india') ? 'is-invalid' : '' }}"
                                        type="number" name="india" id="india" value="{{ old('india', '') }}"
                                        step="1">
                                    @if ($errors->has('india'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('india') }}
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control {{ $errors->has('jepang') ? 'is-invalid' : '' }}"
                                        type="number" name="jepang" id="jepang" value="{{ old('jepang', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control {{ $errors->has('korea_selatan') ? 'is-invalid' : '' }}"
                                        ...
                                        value="{{ old('korea_selatan', '') }}" step="1">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control {{ $errors->has('taiwan') ? 'is-invalid' : '' }}"
                                        type="number" name="taiwan" id="taiwan" value="{{ old('taiwan', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control {{ $errors->has('tiongkok') ? 'is-invalid' : '' }}"
                                        type="number" name="tiongkok" id="tiongkok" value="{{ old('tiongkok', '') }}"
                                        step="1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('kuwait') ? 'is-invalid' : '' }}"
                                        type="number" name="kuwait" id="kuwait" value="{{ old('kuwait', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('mesir') ? 'is-invalid' : '' }}"
                                        type="number" name="mesir" id="mesir" value="{{ old('mesir', '') }}"
                                        step="1">
                                    @if ($errors->has('mesir'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('mesir') }}
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('uae') ? 'is-invalid' : '' }}"
                                        type="number" name="uae" id="uae" value="{{ old('uae', '') }}"
                                        step="1">
                                    @if ($errors->has('uae'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('uae') }}
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('yaman') ? 'is-invalid' : '' }}"
                                        type="number" name="yaman" id="yaman" value="{{ old('yaman', '') }}"
                                        step="1">
                                    @if ($errors->has('yaman'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('yaman') }}
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('timur_tengah_lain', '') }}" step="1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('eropa') ? 'is-invalid' : '' }}"
                                    type="number" name="eropa" id="eropa" value="{{ old('eropa', '') }}"
                                    step="1">
                                @if ($errors->has('eropa'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('eropa') }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('jerman') ? 'is-invalid' : '' }}"
                                        type="number" name="jerman" id="jerman" value="{{ old('jerman', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('belanda') ? 'is-invalid' : '' }}"
                                        type="number" name="belanda" id="belanda" value="{{ old('belanda', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('inggris') ? 'is-invalid' : '' }}"
                                        type="number" name="inggris" id="inggris" value="{{ old('inggris', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('rusia') ? 'is-invalid' : '' }}"
                                        type="number" name="rusia" id="rusia" value="{{ old('rusia', '') }}"
                                        step="1">
                                    @if ($errors->has('rusia'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('rusia') }}
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('eropa_lainnya') ? 'is-invalid' : '' }}"
                                        ...
                                        value="{{ old('eropa_lainnya', '') }}" step="1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('amerika') ? 'is-invalid' : '' }}"
                                    type="number" name="amerika" id="amerika" value="{{ old('amerika', '') }}"
                                    step="1">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('amerika_serikat') ? 'is-invalid' : '' }}"
                                        ...
                                        value="{{ old('amerika_serikat', '') }}" step="1">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('kanada') ? 'is-invalid' : '' }}"
                                        type="number" name="kanada" id="kanada" value="{{ old('kanada', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control {{ $errors->has('brazil') ? 'is-invalid' : '' }}"
                                        type="number" name="brazil" id="brazil" value="{{ old('brazil', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control {{ $errors->has('meksiko') ? 'is-invalid' : '' }}"
                                        type="number" name="meksiko" id="meksiko" value="{{ old('meksiko', '') }}"
                                        step="1">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control {{ $errors->has('amerika_lainnya') ? 'is-invalid' : '' }}"
                                        ...
                                        value="{{ old('amerika_lainnya', '') }}" step="1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('oseania') ? 'is-invalid' : '' }}"
                                    type="number" name="oseania" id="oseania" value="{{ old('oseania', '') }}"
                                    step="1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control {{ $errors->has('selandia_baru') ? 'is-invalid' : '' }}"
                                        ...
                                        value="{{ old('selandia_baru', '') }}" step="1">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control {{ $errors->has('oseania_lainnya') ? 'is-invalid' : '' }}"
                                        ...
                                        value="{{ old('oseania_lainnya', '') }}" step="1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('afrika') ? 'is-invalid' : '' }}"
                                    type="number" name="afrika" id="afrika" value="{{ old('afrika', '') }}"
                                    step="1">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control {{ $errors->has('afrika_selatan') ? 'is-invalid' : '' }}"
                                        ...
                                        value="{{ old('afrika_selatan', '') }}" step="1">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control {{ $errors->has('afrika_lainnya') ? 'is-invalid' : '' }}"
                                        ...
                                        value="{{ old('afrika_lainnya', '') }}" step="1">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    value="{{ old('total_mancanegara', '') }}" step="1">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('jawa') ? 'is-invalid' : '' }}" type="number"
                                name="jawa" id="jawa" value="{{ old('jawa', '') }}" step="1">
                            @if ($errors->has('jawa'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('jawa') }}
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('diy') ? 'is-invalid' : '' }}" type="number"
                                    name="diy" id="diy" value="{{ old('diy', '') }}" step="1">
                                @if ($errors->has('diy'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('diy') }}
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('dki') ? 'is-invalid' : '' }}" type="number"
                                    name="dki" id="dki" value="{{ old('dki', '') }}" step="1">
                                @if ($errors->has('dki'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('dki') }}
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('banten') ? 'is-invalid' : '' }}"
                                    type="number" name="banten" id="banten" value="{{ old('banten', '') }}"
                                    step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('kalimantan') ? 'is-invalid' : '' }}"
                                type="number" name="kalimantan" id="kalimantan" value="{{ old('kalimantan', '') }}"
                                step="1">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('kaltara') ? 'is-invalid' : '' }}"
                                    type="number" name="kaltara" id="kaltara" value="{{ old('kaltara', '') }}"
                                    step="1">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('kaltim') ? 'is-invalid' : '' }}"
                                    type="number" name="kaltim" id="kaltim" value="{{ old('kaltim', '') }}"
                                    step="1">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('kalteng') ? 'is-invalid' : '' }}"
                                    type="number" name="kalteng" id="kalteng" value="{{ old('kalteng', '') }}"
                                    step="1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('kalbar') ? 'is-invalid' : '' }}"
                                    type="number" name="kalbar" id="kalbar" value="{{ old('kalbar', '') }}"
                                    step="1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('kalsel') ? 'is-invalid' : '' }}"
                                    type="number" name="kalsel" id="kalsel" value="{{ old('kalsel', '') }}"
                                    step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('sumatera') ? 'is-invalid' : '' }}"
                                type="number" name="sumatera" id="sumatera" value="{{ old('sumatera', '') }}"
                                step="1">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('aceh') ? 'is-invalid' : '' }}"
                                    type="number" name="aceh" id="aceh" value="{{ old('aceh', '') }}"
                                    step="1">
                                @if ($errors->has('aceh'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('aceh') }}
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('sumut') ? 'is-invalid' : '' }}"
                                    type="number" name="sumut" id="sumut" value="{{ old('sumut', '') }}"
                                    step="1">
                                @if ($errors->has('sumut'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('sumut') }}
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('riau') ? 'is-invalid' : '' }}"
                                    type="number" name="riau" id="riau" value="{{ old('riau', '') }}"
                                    step="1">
                                @if ($errors->has('riau'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('riau') }}
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('kep_riau') ? 'is-invalid' : '' }}"
                                    type="number" name="kep_riau" id="kep_riau" value="{{ old('kep_riau', '') }}"
                                    step="1">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('jambi') ? 'is-invalid' : '' }}"
                                    type="number" name="jambi" id="jambi" value="{{ old('jambi', '') }}"
                                    step="1">
                                @if ($errors->has('jambi'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('jambi') }}
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('sumbar') ? 'is-invalid' : '' }}"
                                    type="number" name="sumbar" id="sumbar" value="{{ old('sumbar', '') }}"
                                    step="1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('sumsel') ? 'is-invalid' : '' }}"
                                    type="number" name="sumsel" id="sumsel" value="{{ old('sumsel', '') }}"
                                    step="1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('bangka') ? 'is-invalid' : '' }}"
                                    type="number" name="bangka" id="bangka" value="{{ old('bangka', '') }}"
                                    step="1">
                                ...
                                @endif
                                <span
                                    class="help-block">{{ trans('cruds.dataKunjungan.fields.bangka_helper') }}</span><br>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('bengkulu') ? 'is-invalid' : '' }}"
                                    type="number" name="bengkulu" id="bengkulu" value="{{ old('bengkulu', '') }}"
                                    step="1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('lampung') ? 'is-invalid' : '' }}"
                                    type="number" name="lampung" id="lampung" value="{{ old('lampung', '') }}"
                                    step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('sulawesi') ? 'is-invalid' : '' }}"
                                type="number" name="sulawesi" id="sulawesi" value="{{ old('sulawesi', '') }}"
                                step="1">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('sulut') ? 'is-invalid' : '' }}"
                                    type="number" name="sulut" id="sulut" value="{{ old('sulut', '') }}"
                                    step="1">
                                @if ($errors->has('sulut'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('sulut') }}
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('sulbar') ? 'is-invalid' : '' }}"
                                    type="number" name="sulbar" id="sulbar" value="{{ old('sulbar', '') }}"
                                    step="1">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('sulteng') ? 'is-invalid' : '' }}"
                                    type="number" name="sulteng" id="sulteng" value="{{ old('sulteng', '') }}"
                                    step="1">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('sulsel') ? 'is-invalid' : '' }}"
                                    type="number" name="sulsel" id="sulsel" value="{{ old('sulsel', '') }}"
                                    step="1">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('sulgara') ? 'is-invalid' : '' }}"
                                    type="number" name="sulgara" id="sulgara" value="{{ old('sulgara', '') }}"
                                    step="1">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('gorontalo') ? 'is-invalid' : '' }}"
                                    type="number" name="gorontalo" id="gorontalo" value="{{ old('gorontalo', '') }}"
                                    step="1">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('bali') ? 'is-invalid' : '' }}"
                                    type="number" name="bali" id="bali" value="{{ old('bali', '') }}"
                                    step="1">
                                @if ($errors->has('bali'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('bali') }}
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('ntb') ? 'is-invalid' : '' }}" type="number"
                                    name="ntb" id="ntb" value="{{ old('ntb', '') }}" step="1">
                                @if ($errors->has('ntb'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('ntb') }}
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('ntt') ? 'is-invalid' : '' }}" type="number"
                                    name="ntt" id="ntt" value="{{ old('ntt', '') }}" step="1">
                                @if ($errors->has('ntt'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('ntt') }}
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('papuaa') ? 'is-invalid' : '' }}" type="number"
                                name="papuaa" id="papuaa" value="{{ old('papuaa', '') }}" step="1">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('maluku') ? 'is-invalid' : '' }}"
                                    type="number" name="maluku" id="maluku" value="{{ old('maluku', '') }}"
                                    step="1">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('papua') ? 'is-invalid' : '' }}"
                                    type="number" name="papua" id="papua" value="{{ old('papua', '') }}"
                                    step="1">
                                @if ($errors->has('papua'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('papua') }}
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('papua_baratdaya') ? 'is-invalid' : '' }}"
                                    ...
                                    value="{{ old('papua_baratdaya', '') }}" step="1">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control {{ $errors->has('papua_selatan') ? 'is-invalid' : '' }}"
                                    ...
                                    value="{{ old('papua_selatan', '') }}" step="1">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control {{ $errors->has('papua_pegunungan') ? 'is-invalid' : '' }}"
                                    ...
                                    value="{{ old('papua_pegunungan', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('total_nusantara', '') }}" step="1">
