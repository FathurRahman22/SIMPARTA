    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.submission-links.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="event_id">{{ trans('cruds.orderTicket.fields.event') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.orderTicket.fields.event_helper') }}</span>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {{-- OSEANIA --}}
                        <div class="form-group">
                            <label class="font-weight-bold" for="oseania">{{ trans('cruds.submissionLink.fields.oseania') }}</label>
                            <input class="form-control {{ $errors->has('oseania') ? 'is-invalid' : '' }}" type="number" name="oseania" id="oseania" value="{{ old('oseania','') }}" step="1" >
                            @if($errors->has('oseania'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('oseania') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.oseania_helper') }}</span> 
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <label class for="australia">{{ trans('cruds.submissionLink.fields.australia') }}</label>
                                <input class="form-control {{ $errors->has('australia') ? 'is-invalid' : '' }}" type="number" name="australia" id="australia" value="{{ old('australia', '') }}" step="1" >
                                @if($errors->has('australia'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('australia') }}
                                    </div>
                                @endif
                                <span class="help-block">{{ trans('cruds.submissionLink.fields.australia_helper') }}</span>
                            </div>
                            <div class="col-md-6">
                                <label class for="selandia_baru">{{ trans('cruds.submissionLink.fields.selandia_baru') }}</label>
                                <input class="form-control {{ $errors->has('selandia_baru') ? 'is-invalid' : '' }}" type="number" name="selandia_baru" id="selandia_baru" value="{{ old('selandia_baru','') }}" step="1" >
                                @if($errors->has('selandia_baru'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('selandia_baru') }}
                                    </div>
                                @endif
                                <span class="help-block">{{ trans('cruds.submissionLink.fields.selandia_baru_helper') }}</span><br>
                            </div>
                            <div class="col-md-6">
                                <label class for="papua_nugini">{{ trans('cruds.submissionLink.fields.papua_nugini') }}</label>
                                <input class="form-control {{ $errors->has('papua_nugini') ? 'is-invalid' : '' }}" type="number" name="papua_nugini" id="papua_nugini" value="{{ old('papua_nugini','') }}" step="1" >
                                @if($errors->has('papua_nugini'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('papua_nugini') }}
                                    </div>
                                @endif
                                <span class="help-block">{{ trans('cruds.submissionLink.fields.papua_nugini_helper') }}</span><br>
                            </div>
                            <div class="col-md-6">
                                <label class for="oseania_lainnya">{{ trans('cruds.submissionLink.fields.oseania_lainnya') }}</label>
                                <input class="form-control {{ $errors->has('oseania_lainnya') ? 'is-invalid' : '' }}" type="number" name="oseania_lainnya" id="oseania_lainnya" value="{{ old('oseania_lainnya', '') }}" step="1" >
                                @if($errors->has('oseania_lainnya'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('oseania_lainnya') }}
                                    </div>
                                @endif
                                <span class="help-block">{{ trans('cruds.submissionLink.fields.oseania_lainnya_helper') }}</span><br>
                            </div>
                        </div>
                        {{-- AFRIKA --}}
                        <div class="form-group">
                            <label class="font-weight-bold" for="afrika">{{ trans('cruds.submissionLink.fields.afrika') }}</label>
                            <input class="form-control {{ $errors->has('afrika') ? 'is-invalid' : '' }}" type="number" name="afrika" id="afrika" value="{{ old('afrika','') }}" step="1" >
                            @if($errors->has('afrika'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('afrika') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.afrika_helper') }}</span> 
                        </div>
                        
                        <div class="row">
                            <div class="col-md-6">
                                <label class for="afrika_selatan">{{ trans('cruds.submissionLink.fields.afrika_selatan') }}</label>
                                <input class="form-control {{ $errors->has('afrika_selatan') ? 'is-invalid' : '' }}" type="number" name="afrika_selatan" id="afrika_selatan" value="{{ old('afrika_selatan', '') }}" step="1" >
                                @if($errors->has('afrika_selatan'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('afrika_selatan') }}
                                    </div>
                                @endif
                                <span class="help-block">{{ trans('cruds.submissionLink.fields.afrika_selatan_helper') }}</span>
                            </div>
                            <div class="col-md-6">
                                <label class for="afrika_lainnya">{{ trans('cruds.submissionLink.fields.afrika_lainnya') }}</label>
                                <input class="form-control {{ $errors->has('afrika_lainnya') ? 'is-invalid' : '' }}" type="number" name="afrika_lainnya" id="afrika_lainnya" value="{{ old('afrika_lainnya','') }}" step="1" >
                                @if($errors->has('afrika_lainnya'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('afrika_lainnya') }}
                                    </div>
                                @endif
                                <span class="help-block">{{ trans('cruds.submissionLink.fields.afrika_lainnya_helper') }}</span><br>
                            </div>
                        </div>
                        {{-- TOTAL MANCANEGARA --}}
                        <div class="form-group">
                            <label class="font-weight-bold" for="total_mancanegara">{{ trans('cruds.submissionLink.fields.total_mancanegara') }}</label>
                            <input class="form-control {{ $errors->has('total_mancanegara') ? 'is-invalid' : '' }} bg-secondary text-black" type="number" name="total_mancanegara" id="total_mancanegara" value="{{ old('total_mancanegara','') }}" step="1" >
                            @if($errors->has('total_mancanegara'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('total_mancanegara') }}
                                </div>
                            @endif
                            <span class="help-block text-black">{{ trans('cruds.submissionLink.fields.total_mancanegara_helper') }}</span>
                        </div>                                            
                    </div> 
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="font-weight-bold" for="jawa">{{ trans('cruds.submissionLink.fields.jawa') }}</label>
                        <input class="form-control {{ $errors->has('jawa') ? 'is-invalid' : '' }}" type="number" name="jawa" id="jawa" value="{{ old('jawa','') }}" step="1" >
                        @if($errors->has('jawa'))
                            <div class="invalid-feedback">
                                {{ $errors->first('jawa') }}
                            </div>
                        @endif
                        <span class="help-block">{{ trans('cruds.submissionLink.fields.jawa_helper') }}</span> 
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label class for="jawa_timur">{{ trans('cruds.submissionLink.fields.jawa_timur') }}</label>
                            <input class="form-control {{ $errors->has('jawa_timur') ? 'is-invalid' : '' }}" type="number" name="jawa_timur" id="jawa_timur" value="{{ old('jawa_timur','') }}" step="1" >
                            @if($errors->has('jawa_timur'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('jawa_timur') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.jawa_timur_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="jawa_barat">{{ trans('cruds.submissionLink.fields.jawa_barat') }}</label>
                            <input class="form-control {{ $errors->has('jawa_barat') ? 'is-invalid' : '' }}" type="number" name="jawa_barat" id="jawa_barat" value="{{ old('jawa_barat','') }}" step="1" >
                            @if($errors->has('jawa_barat'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('jawa_barat') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.jawa_barat_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="jawa_tengah">{{ trans('cruds.submissionLink.fields.jawa_tengah') }}</label>
                            <input class="form-control {{ $errors->has('jawa_tengah') ? 'is-invalid' : '' }}" type="number" name="jawa_tengah" id="jawa_tengah" value="{{ old('jawa_tengah', '') }}" step="1" >
                            @if($errors->has('jawa_tengah'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('jawa_tengah') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.jawa_tengah_helper') }}</span><br>
                        </div>
                        <div class="col-md-4">
                            <label class for="diy">{{ trans('cruds.submissionLink.fields.diy') }}</label>
                            <input class="form-control {{ $errors->has('diy') ? 'is-invalid' : '' }}" type="number" name="diy" id="diy" value="{{ old('diy', '') }}" step="1" >
                            @if($errors->has('diy'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('diy') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.diy_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="dki">{{ trans('cruds.submissionLink.fields.dki') }}</label>
                            <input class="form-control {{ $errors->has('dki') ? 'is-invalid' : '' }}" type="number" name="dki" id="dki" value="{{ old('dki', '') }}" step="1" >
                            @if($errors->has('dki'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('dki') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.dki_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="banten">{{ trans('cruds.submissionLink.fields.banten') }}</label>
                            <input class="form-control {{ $errors->has('banten') ? 'is-invalid' : '' }}" type="number" name="banten" id="banten" value="{{ old('banten', '') }}" step="1" >
                            @if($errors->has('banten'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('banten') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.banten_helper') }}</span><br>
                        </div>
                    </div>
                    {{-- KALIMANTAN --}}
                    <div class="form-group">
                        <label class="font-weight-bold" for="kalimantan">{{ trans('cruds.submissionLink.fields.kalimantan') }}</label>
                        <input class="form-control {{ $errors->has('kalimantan') ? 'is-invalid' : '' }}" type="number" name="kalimantan" id="kalimantan" value="{{ old('kalimantan','') }}" step="1" >
                        @if($errors->has('kalimantan'))
                            <div class="invalid-feedback">
                                {{ $errors->first('kalimantan') }}
                            </div>
                        @endif
                        <span class="help-block">{{ trans('cruds.submissionLink.fields.kalimantan_helper') }}</span>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label class for="kaltara">{{ trans('cruds.submissionLink.fields.kaltara') }}</label>
                            <input class="form-control {{ $errors->has('kaltara') ? 'is-invalid' : '' }}" type="number" name="kaltara" id="kaltara" value="{{ old('kaltara','') }}" step="1" >
                            @if($errors->has('kaltara'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('kaltara') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.kaltara_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="kaltim">{{ trans('cruds.submissionLink.fields.kaltim') }}</label>
                            <input class="form-control {{ $errors->has('kaltim') ? 'is-invalid' : '' }}" type="number" name="kaltim" id="kaltim" value="{{ old('kaltim','') }}" step="1" >
                            @if($errors->has('kaltim'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('kaltim') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.kaltim_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="kalteng">{{ trans('cruds.submissionLink.fields.kalteng') }}</label>
                            <input class="form-control {{ $errors->has('kalteng') ? 'is-invalid' : '' }}" type="number" name="kalteng" id="kalteng" value="{{ old('kalteng', '') }}" step="1" >
                            @if($errors->has('kalteng'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('kalteng') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.kalteng_helper') }}</span><br>
                        </div>
                        <div class="col-md-6">
                            <label class for="kalbar">{{ trans('cruds.submissionLink.fields.kalbar') }}</label>
                            <input class="form-control {{ $errors->has('kalbar') ? 'is-invalid' : '' }}" type="number" name="kalbar" id="kalbar" value="{{ old('kalbar', '') }}" step="1" >
                            @if($errors->has('kalbar'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('kalbar') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.kalbar_helper') }}</span><br>
                        </div>
                        <div class="col-md-6">
                            <label class for="kalsel">{{ trans('cruds.submissionLink.fields.kalsel') }}</label>
                            <input class="form-control {{ $errors->has('kalsel') ? 'is-invalid' : '' }}" type="number" name="kalsel" id="kalsel" value="{{ old('kalsel', '') }}" step="1" >
                            @if($errors->has('kalsel'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('kalsel') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.kalsel_helper') }}</span>
                        </div>
                    </div>
                    {{-- SUMATERA --}}
                    <div class="form-group">
                        <label class="font-weight-bold" for="sumatera">{{ trans('cruds.submissionLink.fields.sumatera') }}</label>
                        <input class="form-control {{ $errors->has('sumatera') ? 'is-invalid' : '' }}" type="number" name="sumatera" id="sumatera" value="{{ old('sumatera','') }}" step="1" >
                        @if($errors->has('sumatera'))
                            <div class="invalid-feedback">
                                {{ $errors->first('sumatera') }}
                            </div>
                        @endif
                        <span class="help-block">{{ trans('cruds.submissionLink.fields.sumatera_helper') }}</span> 
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label class for="aceh">{{ trans('cruds.submissionLink.fields.aceh') }}</label>
                            <input class="form-control {{ $errors->has('aceh') ? 'is-invalid' : '' }}" type="number" name="aceh" id="aceh" value="{{ old('aceh','') }}" step="1" >
                            @if($errors->has('aceh'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('aceh') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.aceh_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="sumut">{{ trans('cruds.submissionLink.fields.sumut') }}</label>
                            <input class="form-control {{ $errors->has('sumut') ? 'is-invalid' : '' }}" type="number" name="sumut" id="sumut" value="{{ old('sumut','') }}" step="1" >
                            @if($errors->has('sumut'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sumut') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.sumut_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="riau">{{ trans('cruds.submissionLink.fields.riau') }}</label>
                            <input class="form-control {{ $errors->has('riau') ? 'is-invalid' : '' }}" type="number" name="riau" id="riau" value="{{ old('riau','') }}" step="1" >
                            @if($errors->has('riau'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('riau') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.riau_helper') }}</span><br>
                        </div>
                        <div class="col-md-4">
                            <label class for="kep_riau">{{ trans('cruds.submissionLink.fields.kep_riau') }}</label>
                            <input class="form-control {{ $errors->has('kep_riau') ? 'is-invalid' : '' }}" type="number" name="kep_riau" id="kep_riau" value="{{ old('kep_riau', '') }}" step="1" >
                            @if($errors->has('kep_riau'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('kep_riau') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.kep_riau_helper') }}</span><br>
                        </div>
                        <div class="col-md-4">
                            <label class for="jambi">{{ trans('cruds.submissionLink.fields.jambi') }}</label>
                            <input class="form-control {{ $errors->has('jambi') ? 'is-invalid' : '' }}" type="number" name="jambi" id="jambi" value="{{ old('jambi', '') }}" step="1" >
                            @if($errors->has('jambi'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('jambi') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.jambi_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="sumbar">{{ trans('cruds.submissionLink.fields.sumbar') }}</label>
                            <input class="form-control {{ $errors->has('sumbar') ? 'is-invalid' : '' }}" type="number" name="sumbar" id="sumbar" value="{{ old('sumbar', '') }}" step="1" >
                            @if($errors->has('sumbar'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sumbar') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.sumbar_helper') }}</span>
                        </div>
                        <div class="col-md-6">
                            <label class for="sumsel">{{ trans('cruds.submissionLink.fields.sumsel') }}</label>
                            <input class="form-control {{ $errors->has('sumsel') ? 'is-invalid' : '' }}" type="number" name="sumsel" id="sumsel" value="{{ old('sumsel', '') }}" step="1" >
                            @if($errors->has('sumsel'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sumsel') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.sumsel_helper') }}</span><br>
                        </div>
                        <div class="col-md-6">
                            <label class for="bangka">{{ trans('cruds.submissionLink.fields.bangka') }}</label>
                            <input class="form-control {{ $errors->has('bangka') ? 'is-invalid' : '' }}" type="number" name="bangka" id="bangka" value="{{ old('bangka', '') }}" step="1" >
                            @if($errors->has('bangka'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('bangka') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.bangka_helper') }}</span>
                        </div>
                        <div class="col-md-6">
                            <label class for="bengkulu">{{ trans('cruds.submissionLink.fields.bengkulu') }}</label>
                            <input class="form-control {{ $errors->has('bengkulu') ? 'is-invalid' : '' }}" type="number" name="bengkulu" id="bengkulu" value="{{ old('bengkulu', '') }}" step="1" >
                            @if($errors->has('bengkulu'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('bengkulu') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.bengkulu_helper') }}</span><br>
                        </div>
                        <div class="col-md-6">
                            <label class for="lampung">{{ trans('cruds.submissionLink.fields.lampung') }}</label>
                            <input class="form-control {{ $errors->has('lampung') ? 'is-invalid' : '' }}" type="number" name="lampung" id="lampung" value="{{ old('lampung', '') }}" step="1" >
                            @if($errors->has('lampung'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('lampung') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.lampung_helper') }}</span><br>
                        </div>
                    </div>
                    {{-- SULAWESI --}}
                    <div class="form-group">
                        <label class="font-weight-bold" for="sulawesi">{{ trans('cruds.submissionLink.fields.sulawesi') }}</label>
                        <input class="form-control {{ $errors->has('sulawesi') ? 'is-invalid' : '' }}" type="number" name="sulawesi" id="sulawesi" value="{{ old('sulawesi','') }}" step="1" >
                        @if($errors->has('sulawesi'))
                            <div class="invalid-feedback">
                                {{ $errors->first('sulawesi') }}
                            </div>
                        @endif
                        <span class="help-block">{{ trans('cruds.submissionLink.fields.sulawesi_helper') }}</span> 
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label class for="sulut">{{ trans('cruds.submissionLink.fields.sulut') }}</label>
                            <input class="form-control {{ $errors->has('sulut') ? 'is-invalid' : '' }}" type="number" name="sulut" id="sulut" value="{{ old('sulut', '') }}" step="1" >
                            @if($errors->has('sulut'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sulut') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.sulut_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="sulbar">{{ trans('cruds.submissionLink.fields.sulbar') }}</label>
                            <input class="form-control {{ $errors->has('sulbar') ? 'is-invalid' : '' }}" type="number" name="sulbar" id="sulbar" value="{{ old('sulbar','') }}" step="1" >
                            @if($errors->has('sulbar'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sulbar') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.sulbar_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="sulteng">{{ trans('cruds.submissionLink.fields.sulteng') }}</label>
                            <input class="form-control {{ $errors->has('sulteng') ? 'is-invalid' : '' }}" type="number" name="sulteng" id="sulteng" value="{{ old('sulteng','') }}" step="1" >
                            @if($errors->has('sulteng'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sulteng') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.sulteng_helper') }}</span><br>
                        </div>
                        <div class="col-md-4">
                            <label class for="sulsel">{{ trans('cruds.submissionLink.fields.sulsel') }}</label>
                            <input class="form-control {{ $errors->has('sulsel') ? 'is-invalid' : '' }}" type="number" name="sulsel" id="sulsel" value="{{ old('sulsel', '') }}" step="1" >
                            @if($errors->has('sulsel'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sulsel') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.sulsel_helper') }}</span><br>
                        </div>
                        <div class="col-md-4">
                            <label class for="sulgara">{{ trans('cruds.submissionLink.fields.sulgara') }}</label>
                            <input class="form-control {{ $errors->has('sulgara') ? 'is-invalid' : '' }}" type="number" name="sulgara" id="sulgara" value="{{ old('sulgara', '') }}" step="1" >
                            @if($errors->has('sulgara'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sulgara') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.sulgara_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="gorontalo">{{ trans('cruds.submissionLink.fields.gorontalo') }}</label>
                            <input class="form-control {{ $errors->has('gorontalo') ? 'is-invalid' : '' }}" type="number" name="gorontalo" id="gorontalo" value="{{ old('gorontalo', '') }}" step="1" >
                            @if($errors->has('gorontalo'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('gorontalo') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.gorontalo_helper') }}</span><br>
                        </div>
                    </div>
                    {{-- BALINUSTRA --}}
                    <div class="form-group">
                        <label class="font-weight-bold" for="bali_nustra">{{ trans('cruds.submissionLink.fields.bali_nustra') }}</label>
                        <input class="form-control {{ $errors->has('bali_nustra') ? 'is-invalid' : '' }}" type="number" name="bali_nustra" id="bali_nustra" value="{{ old('bali_nustra','') }}" step="1" >
                        @if($errors->has('bali_nustra'))
                            <div class="invalid-feedback">
                                {{ $errors->first('bali_nustra') }}
                            </div>
                        @endif
                        <span class="help-block">{{ trans('cruds.submissionLink.fields.bali_nustra_helper') }}</span> 
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label class for="bali">{{ trans('cruds.submissionLink.fields.bali') }}</label>
                            <input class="form-control {{ $errors->has('bali') ? 'is-invalid' : '' }}" type="number" name="bali" id="bali" value="{{ old('bali', '') }}" step="1" >
                            @if($errors->has('bali'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('bali') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.bali_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="ntb">{{ trans('cruds.submissionLink.fields.ntb') }}</label>
                            <input class="form-control {{ $errors->has('ntb') ? 'is-invalid' : '' }}" type="number" name="ntb" id="ntb" value="{{ old('ntb','') }}" step="1" >
                            @if($errors->has('ntb'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ntb') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.ntb_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="ntt">{{ trans('cruds.submissionLink.fields.ntt') }}</label>
                            <input class="form-control {{ $errors->has('ntt') ? 'is-invalid' : '' }}" type="number" name="ntt" id="ntt" value="{{ old('ntt', '') }}" step="1" >
                            @if($errors->has('ntt'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ntt') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.ntt_helper') }}</span><br>
                        </div>
                    </div>
                    {{-- PAPUA --}}
                    <div class="form-group">
                        <label class="font-weight-bold" for="papuaa">{{ trans('cruds.submissionLink.fields.papuaa') }}</label>
                        <input class="form-control {{ $errors->has('papuaa') ? 'is-invalid' : '' }}" type="number" name="papuaa" id="papuaa" value="{{ old('papuaa','') }}" step="1" >
                        @if($errors->has('papuaa'))
                            <div class="invalid-feedback">
                                {{ $errors->first('papuaa') }}
                            </div>
                        @endif
                        <span class="help-block">{{ trans('cruds.submissionLink.fields.papuaa_helper') }}</span> 
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <label class for="maluku">{{ trans('cruds.submissionLink.fields.maluku') }}</label>
                            <input class="form-control {{ $errors->has('maluku') ? 'is-invalid' : '' }}" type="number" name="maluku" id="maluku" value="{{ old('maluku', '') }}" step="1" >
                            @if($errors->has('maluku'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('maluku') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.maluku_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="maluku_utara">{{ trans('cruds.submissionLink.fields.maluku_utara') }}</label>
                            <input class="form-control {{ $errors->has('maluku_utara') ? 'is-invalid' : '' }}" type="number" name="maluku_utara" id="maluku_utara" value="{{ old('maluku_utara','') }}" step="1" >
                            @if($errors->has('maluku_utara'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('maluku_utara') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.maluku_utara_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="papua">{{ trans('cruds.submissionLink.fields.papua') }}</label>
                            <input class="form-control {{ $errors->has('papua') ? 'is-invalid' : '' }}" type="number" name="papua" id="papua" value="{{ old('papua','') }}" step="1" >
                            @if($errors->has('papua'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('papua') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.papua_helper') }}</span><br>
                        </div>
                        <div class="col-md-4">
                            <label class for="papua_barat">{{ trans('cruds.submissionLink.fields.papua_barat') }}</label>
                            <input class="form-control {{ $errors->has('papua_barat') ? 'is-invalid' : '' }}" type="number" name="papua_barat" id="papua_barat" value="{{ old('papua_barat', '') }}" step="1" >
                            @if($errors->has('papua_barat'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('papua_barat') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.papua_barat_helper') }}</span><br>
                        </div>
                        <div class="col-md-4">
                            <label class for="papua_baratdaya">{{ trans('cruds.submissionLink.fields.papua_baratdaya') }}</label>
                            <input class="form-control {{ $errors->has('papua_baratdaya') ? 'is-invalid' : '' }}" type="number" name="papua_baratdaya" id="papua_baratdaya" value="{{ old('papua_baratdaya', '') }}" step="1" >
                            @if($errors->has('papua_baratdaya'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('papua_baratdaya') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.papua_baratdaya_helper') }}</span>
                        </div>
                        <div class="col-md-4">
                            <label class for="papua_selatan">{{ trans('cruds.submissionLink.fields.papua_selatan') }}</label>
                            <input class="form-control {{ $errors->has('papua_selatan') ? 'is-invalid' : '' }}" type="number" name="papua_selatan" id="papua_selatan" value="{{ old('papua_selatan','') }}" step="1" >
                            @if($errors->has('papua_selatan'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('papua_selatan') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.papua_selatan_helper') }}</span>
                        </div>                            
                        <div class="col-md-6">
                            <label class for="papua_tengah">{{ trans('cruds.submissionLink.fields.papua_tengah') }}</label>
                            <input class="form-control {{ $errors->has('papua_tengah') ? 'is-invalid' : '' }}" type="number" name="papua_tengah" id="papua_tengah" value="{{ old('papua_tengah','') }}" step="1" >
                            @if($errors->has('papua_tengah'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('papua_tengah') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.papua_tengah_helper') }}</span><br>
                        </div>
                        <div class="col-md-6">
                            <label class for="papua_pegunungan">{{ trans('cruds.submissionLink.fields.papua_pegunungan') }}</label>
                            <input class="form-control {{ $errors->has('papua_pegunungan') ? 'is-invalid' : '' }}" type="number" name="papua_pegunungan" id="papua_pegunungan" value="{{ old('papua_pegunungan', '') }}" step="1" >
                            @if($errors->has('papua_pegunungan'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('papua_pegunungan') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.submissionLink.fields.papua_pegunungan_helper') }}</span><br>
                        </div>
                    </div>
                    {{-- TOTAL NUSANTARA --}}
                    <div class="form-group">
                        <label class="font-weight-bold" for="total_nusantara">{{ trans('cruds.submissionLink.fields.total_nusantara') }}</label>
                        <input class="form-control {{ $errors->has('total_nusantara') ? 'is-invalid' : '' }} bg-secondary text-black" type="number" name="total_nusantara" id="total_nusantara" value="{{ old('total_nusantara','') }}" step="1" >
                        @if($errors->has('total_nusantara'))
                            <div class="invalid-feedback">
                                {{ $errors->first('total_nusantara') }}
                            </div>
                        @endif
                        <span class="help-block text-black">{{ trans('cruds.submissionLink.fields.total_nusantara_helper') }}</span>
                    </div>       
                    <div class="form-group">
...
// AMERIKA
$(document).ready(function () {
    $('#amerika_serikat, #kanada, #brazil, #meksiko, #rusia, #amerika_lainnya').on('input', function () {
        ...
        var totalAmerika = amerikaSerikatValue + kanadaValue + brazilValue + meksikoValue + rusiaValue + amerikaLainnyaValue;
        $('#amerika').val(totalAmerika);
    });
});
// OSEANIA
$(document).ready(function () {
    $('#australia, #selandia_baru, #papua_nugini, #oseania_lainnya, #amerika_lainnya').on('input', function () {
        ...
        var totalOseania = australiaValue + selandiaBaruValue + papuaNuginiValue + oseaniaLainnyaValue + amerikaLainnyaValue;
        $('#oseania').val(totalOseania);
    });
});
// AFRIKA
$(document).ready(function () {
    $('#afrika_selatan, #afrika_lainnya, #oseania_lainnya').on('input', function () {
        var afrikaSelatanValue = parseInt($('#afrika_selatan').val()) || 0;
        var afrikaLainnyaValue = parseInt($('#afrika_lainnya').val()) || 0;
        var oseaniaLainnyaValue = parseInt($('#oseania_lainnya').val()) || 0;
        
        var totalAfrika = afrikaSelatanValue + afrikaLainnyaValue + oseaniaLainnyaValue;
