            ...
            <form method="POST" action="{{ route('admin.pakets.update', [$paket->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nama_paketWisata') ? 'is-invalid' : '' }}" type="text"
                        name="nama_paketWisata" id="nama_paketWisata"
                        value="{{ old('nama_paketWisata', $paket->nama_paketWisata) }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('deskripsi_paketWisata') ? 'is-invalid' : '' }}"
                        name="deskripsi_paketWisata" id="deskripsi_paketWisata">{!! old('deskripsi_paketWisata', $paket->deskripsi_paketWisata) !!}</textarea>
