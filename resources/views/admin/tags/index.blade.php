...
@section('content')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/tag/tag_index.css') }}">
    @can('tag_create')
    ...
    <div class="card">
        ...
        {{ trans('global.list') }} {{ trans('cruds.tag.title_singular') }}
        </div>
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Tag:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
