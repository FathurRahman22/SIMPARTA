            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Barang">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.barang.fields.nama_paketWisata') }}
                        </th>
                        <th>
                            {{ trans('cruds.barang.fields.deskripsi_paketWisata') }}
                        </th>
                        <th>
                            {{ trans('cruds.barang.fields.gambar_paketWisata') }}
                        </th>
                        {{-- <th>
                ...
                <tbody>
                    @foreach($barangs as $key => $barang)
                        <tr data-entry-id="{{ $barang->id }}">
                            ...
                            <td>
                                {{ $barang->nama_paketWisata ?? '' }}
                            </td>
                            <td>
                                {{ $barang->deskripsi_paketWisata ?? '' }}
                            </td>
                            <td>
                                @foreach($barang->gambar_paketWisata as $key => $media)
