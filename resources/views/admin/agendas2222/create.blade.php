    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.barangs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deskripsi_paketWisata') ? 'is-invalid' : '' }}" type="text" name="deskripsi_paketWisata" id="deskripsi_paketWisata" value="{{ old('deskripsi_paketWisata', '') }}">
