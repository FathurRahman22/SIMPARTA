...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.fasilitasWisata.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.fasilitasWisatas.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="dataprofil_id">{{ trans('cruds.fasilitasWisata.fields.dataprofil') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.fasilitasWisata.fields.dataprofil_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="nama_fasilitasWisata">{{ trans('cruds.fasilitasWisata.fields.nama_fasilitasWisata') }}</label>
                <input class="form-control {{ $errors->has('nama_fasilitasWisata') ? 'is-invalid' : '' }}" type="text" name="nama_fasilitasWisata" id="nama_fasilitasWisata" value="{{ old('nama_fasilitasWisata', '') }}" required>
            ...
            <div class="form-group">
                <label for="deskripsi_fasilitasWisata">{{ trans('cruds.fasilitasWisata.fields.deskripsi_fasilitasWisata') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('deskripsi_fasilitasWisata') ? 'is-invalid' : '' }}" name="deskripsi_fasilitasWisata" id="deskripsi_fasilitasWisata">{!! old('deskripsi_fasilitasWisata') !!}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="gambar_fasilitasWisata">{{ trans('cruds.fasilitasWisata.fields.gambar_fasilitasWisata') }}</label>
                <div class="needsclick dropzone {{ $errors->has('gambar_fasilitasWisata') ? 'is-invalid' : '' }}" id="gambar_fasilitasWisata-dropzone">
                </div>
            ...
            {{-- <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kode_fasilitasWisata') ? 'is-invalid' : '' }}" type="text" name="kode_fasilitasWisata" id="kode_fasilitasWisata" value="{{ old('kode_fasilitasWisata', '') }}" required>
...
@if(isset($fasilitasWisata) && $fasilitasWisata->gambar_fasilitasWisata)
      var files = {!! json_encode($fasilitasWisata->gambar_fasilitasWisata) !!}
          ...
          $('form').append('<input type="hidden" name="gambar_fasilitasWisata[]" value="' + file.file_name + '">')
        }
@endif
    },
