                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="daftar_usaha_pariwisata" id="daftar_usaha_pariwisata">
                        <option value="Hotel dan Akomodasi Lainnya"
                            {{ old('daftar_usaha_pariwisata') == 'Hotel dan Akomodasi Lainnya' ? 'selected' : '' }}>Hotel
                            dan Akomodasi Lainnya</option>
                        <option value="Daya Tarik Wisata"
                            {{ old('daftar_usaha_pariwisata') == 'Daya Tarik Wisata' ? 'selected' : '' }}>Daya Tarik Wisata
                        </option>
                        <option value="Restoran" {{ old('daftar_usaha_pariwisata') == 'Restoran' ? 'selected' : '' }}>
                            Restoran</option>
                        <option value="Kafe" {{ old('daftar_usaha_pariwisata') == 'Kafe' ? 'selected' : '' }}>Kafe
                        </option>
                        <option value="Usaha Makanan"
                            {{ old('daftar_usaha_pariwisata') == 'Usaha Makanan' ? 'selected' : '' }}>Usaha Makanan
                        </option>
                        <option value="Usaha Minuman"
                            {{ old('daftar_usaha_pariwisata') == 'Usaha Minuman' ? 'selected' : '' }}>Usaha Minuman
                        </option>
                        <option value="Bar, Klub Malam, dan Karaoke"
                            {{ old('daftar_usaha_pariwisata') == 'Bar, Klub Malam, dan Karaoke' ? 'selected' : '' }}>Bar,
                            Klub Malam, dan Karaoke</option>
                        <option value="SPA dan Rumah Pijat"
                            {{ old('daftar_usaha_pariwisata') == 'SPA dan Rumah Pijat' ? 'selected' : '' }}>SPA dan Rumah
                            Pijat</option>
                        <option value="Jasa Pariwisata"
                            {{ old('daftar_usaha_pariwisata') == 'Jasa Pariwisata' ? 'selected' : '' }}>Jasa Pariwisata
                        </option>
                        <option value="Perkemahan dan Pondok Wisata"
                            {{ old('daftar_usaha_pariwisata') == 'Perkemahan dan Pondok Wisata' ? 'selected' : '' }}>
                            Perkemahan dan Pondok Wisata</option>
                        <option value="Taman Rekreasi dan Hiburan"
                            {{ old('daftar_usaha_pariwisata') == 'Taman Rekreasi dan Hiburan' ? 'selected' : '' }}>Taman
                            Rekreasi dan Hiburan</option>
                        <option value="Aktivitas Desain dan Fotografi"
                            {{ old('daftar_usaha_pariwisata') == 'Aktivitas Desain dan Fotografi' ? 'selected' : '' }}>
                            Aktivitas Desain dan Fotografi</option>
                        <option value="Seni Pertunjukan"
                            {{ old('daftar_usaha_pariwisata') == 'Seni Pertunjukan' ? 'selected' : '' }}>Seni Pertunjukan
                        </option>
                        <option value="Fasilitas Olahraga"
                            {{ old('daftar_usaha_pariwisata') == 'Fasilitas Olahraga' ? 'selected' : '' }}>Fasilitas
                            Olahraga</option>
                    </select>
