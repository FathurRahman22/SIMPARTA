                ...
                <tbody>
                    @foreach($dataprofils as $key => $dataprofil)
                        <tr data-entry-id="{{ $dataprofil->id }}">
                            ...
                            <td>
                                @can('dataprofil_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.dataprofils.show', $dataprofil->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('dataprofil_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.dataprofils.edit', $dataprofil->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('dataprofil_delete')
                                    <form action="{{ route('admin.dataprofils.destroy', $dataprofil->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@endcan
  ...
  let table = $('.datatable-dataprofil:not(.ajaxTable)').DataTable({ buttons: dtButtons })
