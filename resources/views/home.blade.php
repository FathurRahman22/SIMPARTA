...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <button class="btn btn-primary" type="button" id="get-current-location">Ambil Lokasi Saat
                                Ini</button>
                        </div>
                    </div>
    ...
    <style>
        ...
        #mapid {
            height: 90em;
            /* Sesuaikan dengan ukuran yang Anda inginkan, dalam contoh ini tingginya setara dengan 105% dari tinggi viewport (vh) */
        }
        ...
        .table td img {
            ...
            height: auto;
            display: block;
            /* Membuat gambar berada di tengah kolom */
            margin: 0 auto;
            /* Pusatkan gambar horizontal */
        }

        /* Gaya animasi saat gambar diklik */
        .table td img:hover {
            transform: scale(1.1);
            /* Mengubah ukuran gambar saat diklik */
